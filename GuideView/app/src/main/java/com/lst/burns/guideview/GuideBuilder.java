 ...
 * {@link com.lst.burns.guideview.Component},设置文字或者图片等
 * {@link com.lst.burns.guideview.Component#getView(android.view.LayoutInflater)}
 * . 所有的图片文字都是相对于targetRect来定义的。可以设定额外的x，
 * {@link com.lst.burns.guideview.Component#getXOffset()} ;y偏移量,
 * {@link com.lst.burns.guideview.Component#getYOffset()}。
 * </p>
 * <p>
