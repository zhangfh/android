...
public class PostOffice extends HandlerThread {
        ...
        Handler handler =
                new Handler(getLooper()) {
                    ...
                    public void handleMessage(Message msg) {
                        ...
                        if (client != null) {
                            System.out.println("handleMessage arg1: " + msg.arg1 + " arg2 " + msg.arg2 + " body: " + (String)msg.obj);
                            System.out.println("Postoffice thread:" + Thread.currentThread().getName() );
    ...
    public synchronized void sendPost(Post post) throws InvalidRequestException, NotRegisteredException {
        ...
        System.out.println("sendPost senderid " + post.getSenderId() );
        System.out.println("sendPost getReceiverId " + post.getReceiverId() );
